...
<section id="hero" class="relative overflow-hidden border-b border-white/5 bg-slate-950">
	...
	></div>
	<div
		class="absolute inset-x-0 top-0 -z-10 h-40 bg-gradient-to-b from-cyan-500/20 via-transparent to-transparent"
	></div>

	<div class="flex flex-col lg:min-h-[32rem] lg:flex-row">
		<div class="w-full px-6 py-20 text-left sm:py-24 lg:w-[55%] lg:px-16 xl:px-24">
		...
		<div class="relative w-full lg:min-h-[32rem] lg:flex-1">
			...
			/>
			<div
				class="pointer-events-none absolute inset-0 bg-gradient-to-l from-slate-950/40 via-slate-900/10 to-transparent"
				aria-hidden="true"
			></div>
		</div>
	</div>
