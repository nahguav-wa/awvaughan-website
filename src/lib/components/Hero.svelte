<script lang="ts">
	...
	> = {
		eyebrow: 'Land Services & Site Support',
		heading: 'Owner-operated site support for Hampton Roads properties.',
		subheading: 'Hands-on grading, hauling, and land care you can trust.',
		description: [
			'From driveway resurfacing to hauling and land care, AW Vaughan Company handles the detail work that keeps your property moving.',
			'Owner Alex Vaughan is on site for every project—coordinating trusted partners when extra hands or equipment are needed.'
		]
	};
	...
	>
		...
		>
			<div>
				...
				<p class="mt-2 text-2xl font-bold text-white">Alex on site for every job</p>
				<p class="mt-3 text-sm text-slate-200">
					Work directly with the owner who plans the scope, runs the equipment, and signs off on the
					final result.
				</p>
			</div>
			<div>
				...
				<p class="mt-3 text-sm text-slate-200">
					Virginia Beach, Norfolk, Chesapeake, and the Tidewater communities rely on a familiar face
					for ongoing site care.
				</p>
			</div>
		</div>
	</div>
