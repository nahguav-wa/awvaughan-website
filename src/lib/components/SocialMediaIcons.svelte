<!--
	...
	Reusable component for displaying social media links with consistent icons
-->
<script lang="ts">
...
<div class={containerClass}>
	...
	>
		<svg class={iconSize} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
			<path
				d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6.5 18.5h-3.25V12c0-1.79-1.46-3.25-3.25-3.25S8.75 10.21 8.75 12v6.5H5.5V12c0-3.584 2.916-6.5 6.5-6.5s6.5 2.916 6.5 6.5v6.5z"
			/>
		</svg>
	</a>
</div>
