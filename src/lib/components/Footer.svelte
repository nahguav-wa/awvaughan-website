<footer class="bg-gray-900 text-white py-12">
	<div class="container mx-auto px-4">
		<div class="grid md:grid-cols-4 gap-8">
			<div>
				<h3 class="text-lg font-semibold mb-4">The A.W. Vaughan Company</h3>
			...
			<div>
				...
				<ul class="space-y-2 text-gray-400">
					...
					<li>757-402-1100</li>
					<li>alex.vaughan@awvaughan.com</li>
				</ul>
			</div>
			<div>
		...
		<div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
			<p>&copy; {new Date().getFullYear()} The A.W. Vaughan Company. All rights reserved.</p>
		</div>
	</div>
</footer>