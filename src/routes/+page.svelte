        ...
        <div class="mx-auto max-w-6xl px-6">
                <div class="max-w-3xl space-y-4">
                        ...
                        <p class="text-base text-[var(--text-muted)] sm:text-lg">
                                Clients choose us for Garney-level reliability with a tight-knit crew. These highlights reinforce
                                why builders and property managers across Hampton Roads keep us on call.
                        </p>
                </div>
                                ...
                                >
                                        ...
                                        <div class="flex flex-1 flex-col gap-4 p-6">
                                                ...
                                                <div class="mt-auto pt-4">
                                                        <a
                                                                href={resolve('/services')}
                                                                class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.25em] text-[var(--brand-blue)] transition hover:text-[var(--brand-orange)]"
                                                        >
                                                                Explore more
                                                                <svg
                                                                        class="h-3 w-3"
                                ...
                                >
                                        ...
                                        <div class="flex flex-1 flex-col gap-4 p-6">
                                                ...
                                                <div class="mt-auto pt-4">
                                                        <a
                                                                href={resolve('/contact')}
                                                                class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.25em] text-[var(--brand-orange)] transition hover:text-[var(--brand-blue)]"
                                                        >
                                                                Start your project
                                                                <svg
                                                                        class="h-3 w-3"
...
<section class="border-b border-[var(--border-soft)] bg-[var(--surface-muted)] py-20">
        <div class="mx-auto max-w-5xl px-6">
                <div class="rounded-3xl border border-[var(--border-soft)] bg-[var(--surface-base)] p-10 shadow-sm">
                        <p class="text-xs font-semibold uppercase tracking-[0.35em] text-[var(--brand-blue)]">From our owner</p>
                        <blockquote class="mt-6 text-2xl font-semibold text-[var(--text-dark)] sm:text-3xl">
                                “{testimonial.quote}”
                        </blockquote>
                        <p class="mt-6 text-sm font-semibold uppercase tracking-[0.3em] text-[var(--brand-orange)]">
                                {testimonial.name}
                        </p>
                        <p class="text-sm text-[var(--text-muted)]">{testimonial.role}</p>
                        <div class="mt-8 flex flex-wrap gap-3 text-xs font-semibold uppercase tracking-[0.28em] text-[var(--text-muted)]">
                                {#each serviceArea as area (area)}
                                        <span class="inline-flex items-center gap-2 rounded-full border border-[var(--border-soft)] px-4 py-2">
...
<section id="contact" class="bg-[var(--brand-blue)] py-20 text-white">
        <div class="mx-auto max-w-4xl rounded-3xl border border-white/20 bg-white/5 px-6 py-16 text-center shadow-[var(--brand-blue)]/30 shadow-2xl">
                ...
                <p class="mt-3 text-base text-white/80 sm:text-lg">
                        Share your scope, timeline, and maintenance needs. We’ll provide a plan that keeps your property accessible,
                        safe, and ready for the next milestone.
                </p>
                <div class="mt-8 flex flex-col items-center justify-center gap-4 text-sm text-white/80 sm:flex-row sm:text-base">
                        ...
                        <a class="inline-flex items-center gap-2 transition hover:text-white" href={`mailto:${email}`}>
                                <span class="h-2 w-2 rounded-full bg-[var(--brand-orange)]" aria-hidden="true"></span>
                                {email}
                        </a>
                        <span class="hidden h-4 w-px bg-white/30 sm:inline" aria-hidden="true"></span>
